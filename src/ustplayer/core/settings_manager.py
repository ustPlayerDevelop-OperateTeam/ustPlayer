    ...
    def build_ust_info(self, core_ust_info: UstInfo) -> PlayerLaunchParams:
        ...
        return PlayerLaunchParams(
            ...
            show=ShowConfig(
                ...
                note_name=self.display.show_note_name,
                ust_lyric=self.display.show_ust_lyric,
                copyright=self.display.show_copyright,
                font_note=self.display.font_note,
                font_ust_lyric=self.display.font_ust_lyric,
                font_lrc=self.display.font_lrc,
                font_other=self.display.font_other,
                custom_font_paths=self.display.custom_font_paths,
            ),
            project=ProjectInfo(
