...
class OtherPage(ScrollPage):
    ...
    def _window_effect_text(key: str) -> str:
        return tr({"none": tr("关闭"), "acrylic": tr("亚克力"), "mica": tr("Mica")}.get(key, tr("Mica")))

    @staticmethod
    def _theme_combo_text(mode: str) -> str:
        return tr({"auto": tr("跟随系统"), "light": tr("亮色"), "dark": tr("暗色")}.get(mode, tr("跟随系统")))

    @staticmethod
    def _accent_mode_text(mode: str) -> str:
        return tr({"auto": tr("跟随系统"), "custom": tr("自定义")}.get(mode, tr("跟随系统")))
    ...
    def _setup_ui(self):
        ...
        self._fill_combo(self.theme_combo, {"auto": tr("跟随系统"), "light": tr("亮色"), "dark": tr("暗色")})
        ...
        self._fill_combo(self.accent_color_mode_combo, {"auto": tr("跟随系统"), "custom": tr("自定义")})
    ...
    def retranslate(self):
        ...
        self._refill_combo(self.accent_color_mode_combo, {"auto": tr("跟随系统"), "custom": tr("自定义")})
    ...
    def _connect_signals(self):
        ...
        self.accent_color_mode_combo.currentIndexChanged.connect(self._on_accent_color_mode_combo_changed)
